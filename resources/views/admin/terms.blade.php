            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row mb-2 justify-content-between">
                        ...
                        <div class="col-sm-2">
                        <a href="{{ route(strtolower($title).'.create') }}" class="btn btn-block btn-outline-primary">Add New</a>
                        </div>
                    </div>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">                    
                    <table id="terms-table" class="table table-bordered table-hover" style="width: 100%;">
                        <thead>
                        <tr>
                            <th>#</th>                            
                            <th>Name</th>
    ...
    <script>
        $(function() {
            ...
            ajax: {
              ...
              url: "{!! route('terms.getTerms') !!}",
              data: function(d) {
                d.date = $('#reservation').val(),     
                d.type = '{{ strtolower($title) }}'
              },
              type: 'post'
            },
            columns: [{
